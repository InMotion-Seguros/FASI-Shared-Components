...
Namespace Extensions
    ...
    Public Module AppSettingsExtensions
        ...
        <Extension()>
        Function AppSettings(Of T)(ByVal key As String, Optional throwIfNotExit As Boolean = False) As T
            Dim result As T
            Dim converter As TypeConverter = TypeDescriptor.GetConverter(GetType(T))
            If ConfigurationManager.AppSettings(key) Is Nothing AndAlso throwIfNotExit Then
            ...
            Else
                If ConfigurationManager.AppSettings(key) IsNot Nothing Then
                    'If TypeOf result IsNot Boolean
