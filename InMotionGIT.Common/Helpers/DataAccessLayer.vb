...
#Region "Shared Members"
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Shared Function QueryExecuteToTableJSON(command As DbCommand, currentConnection As DbConnection, behavior As CommandBehavior, table As String, returnEmptyDataTable As Boolean, parameters As Dictionary(Of String, String)) As DataTable
        ...
        Public Shared Function QueryExecuteToTable(statement As String, currentConnection As DbConnection, behavior As CommandBehavior, table As String) As DataTable
            Return QueryExecuteToTable(statement, currentConnection, behavior, table, New Dictionary(Of String, String))
        End Function

        Public Shared Function QueryExecuteToTable(statement As String, currentConnection As DbConnection, behavior As CommandBehavior, table As String, Optional parameters As Dictionary(Of String, String) = Nothing) As DataTable
            Dim result As DataTable = Nothing
        ...
        Public Shared Function QueryExecuteToTable(command As DbCommand, currentConnection As DbConnection, behavior As CommandBehavior, table As String, returnEmptyDataTable As Boolean, parameters As Dictionary(Of String, String)) As DataTable
            Dim result As DataTable = Nothing
            Dim Message As String = ""
            Dim indexStack As Integer = IIf("DataManager.Mode".AppSettingsOnEquals("remote"), 4, 2)

            Dim dataReaderItem As DbDataReader = QueryExecute(command, currentConnection, behavior, table, Message, True, parameters)
        ...
        Public Shared Function QueryExecuteToTable(command As DbCommand, currentConnection As DbConnection, behavior As CommandBehavior, table As String, parameters As Dictionary(Of String, String)) As DataTable
            Return QueryExecuteToTable(command, currentConnection, behavior, table, False, parameters)
        End Function

        Public Shared Function QueryExecuteToTableString(command As DbCommand, currentConnection As DbConnection, behavior As CommandBehavior, table As String, parameters As Dictionary(Of String, String)) As String
        ...
        Public Shared Function QueryExecute(command As DbCommand, currentConnection As DbConnection, behavior As CommandBehavior, table As String) As DbDataReader
            Return QueryExecute(command, currentConnection, behavior, table, String.Empty, False, New Dictionary(Of String, String))
        End Function

        Public Shared Function QueryExecute(command As DbCommand, currentConnection As DbConnection, behavior As CommandBehavior, table As String, Optional parameters As Dictionary(Of String, String) = Nothing) As DbDataReader
            Return QueryExecute(command, currentConnection, behavior, table, String.Empty, False, parameters)
        End Function

        Public Shared Function QueryExecute(command As DbCommand, currentConnection As DbConnection, behavior As CommandBehavior, table As String, ByRef Message As String, IsRetrieve As Boolean, Optional parameters As Dictionary(Of String, String) = Nothing) As DbDataReader
            Dim result As DbDataReader = Nothing
            Dim watch As Stopwatch
        ...
        Public Shared Function ProcedureExecute(command As DbCommand, currentConnection As DbConnection) As Integer
            Return CommandExecute(command, currentConnection, command.CommandText, "ProcedureExecute", New Dictionary(Of String, String))
        End Function

        Public Shared Function ProcedureExecute(command As DbCommand, currentConnection As DbConnection, Optional parameters As Dictionary(Of String, String) = Nothing) As Integer
        ...
        Public Shared Function QueryExecuteScalar(Of T)(command As DbCommand, currentConnection As DbConnection, table As String, Optional parameters As Dictionary(Of String, String) = Nothing) As T
            Dim result As T
        ...
        Public Shared Function CommandExecute(command As DbCommand, currentConnection As DbConnection, table As String, commandKind As String) As Integer
            Return CommandExecute(command, currentConnection, table, commandKind, New Dictionary(Of String, String))
        End Function

        Public Shared Function CommandExecute(command As DbCommand, currentConnection As DbConnection, table As String, commandKind As String, Optional parameters As Dictionary(Of String, String) = Nothing) As Integer
            Dim result As Integer = 0
            Dim watch As Stopwatch
...
#End Region
        ...
        Public Shared Sub TraceLog(parameters As Dictionary(Of String, String), watch As Stopwatch, message As String, result As Object, method As String, indexStack As Integer, command As DbCommand, table As String)
            If "DataAccessLayer.Debug".AppSettings(Of Boolean) Then
                message = "{2}              Mode: {1}{2}              Id: {0}{2}              {3}".SpecialFormater(parameters("Id"), "DataManager.Mode".AppSettings(), Environment.NewLine, DataAccessLayer.MakeCommandSummary(command, table, "Query", Nothing, Nothing, False))
                If parameters.IsNotEmpty() Then
