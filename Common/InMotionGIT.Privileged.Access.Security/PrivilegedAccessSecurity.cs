...
namespace InMotionGIT.Privileged.Access.Security
{
    public class PrivilegedAccessSecurity
    {
        ...
        public static MethodInfo MethodLoad()
        {
            ...
            {
                var assembly = Assembly.LoadFrom(System.IO.Path.Combine(System.IO.Path.GetDirectoryName(new System.Uri(System.Reflection.Assembly.GetExecutingAssembly().CodeBase).LocalPath), "InMotionGIT.Privileged.Access.Security.dll"));
                try
                {
