        ...
        Public Function QueryExecuteToLookup(command As DataCommand) As List(Of DataType.LookUpValue) Implements IDataManager.QueryExecuteToLookup
            ...
            Using db As DbConnection = ConnectionOpenLocal(command)
                ...
                Using commandItem As DbCommand = db.CreateCommand()
                    ...
                    End With
                    BuildParameters(command, commandItem)
                    resultTable = DataAccessLayer.QueryExecuteToTable(commandItem, db, CommandBehavior.Default, command.TableName, New Dictionary(Of String, Object) From {{"CompanyId", command.CompanyId}})
        ...
        Public Function ProcedureExecuteToTable(command As DataCommand, resultEmpty As Boolean) As QueryResult Implements IDataManager.ProcedureExecuteToTable
            ...
            Using db As DbConnection = ConnectionOpenLocal(command)
                ...
                Using commandItem As DbCommand = db.CreateCommand()
                    ...
                    result.Table = DataAccessLayer.QueryExecuteToTable(commandItem, db, CommandBehavior.Default, command.TableName, resultEmpty, New Dictionary(Of String, Object) From {{"CompanyId", command.CompanyId}})
...
#End Region
        ...
        ''' </summary>
        ''' <returns></returns>
        Public Function Check(parameters As Dictionary(Of String, Object)) As List(Of String) Implements IDataManager.Check
