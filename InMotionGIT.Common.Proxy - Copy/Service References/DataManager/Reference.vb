...
Namespace DataManager
    ...
    Public Interface IDataManager
        ...
        Function Check(ByVal parameters As System.Collections.Generic.Dictionary(Of String, Object)) As System.Collections.Generic.List(Of String)
    End Interface
    ...
    Partial Public Class DataManagerClient
        ...
        Public Function Check(ByVal parameters As System.Collections.Generic.Dictionary(Of String, Object)) As System.Collections.Generic.List(Of String) Implements DataManager.IDataManager.Check
